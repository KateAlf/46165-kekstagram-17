  ...
  window.initFormValidation = function () {
    ...
    var checkHashtags = function () {
      ...
      if (errorMessage) {
        ...
        hashtag.style.border = '2px solid #dc143c';
      } else {
        hashtag.style.border = '2px solid #0bda51';
    ...
    form.addEventListener('submit', function (evt) {
      ...
      if (!hashtag.validationMessage) {
        window.server.upload(new FormData(form), window.serverStatus.responseData, window.serverStatus.showErrorOfLoadForm);
